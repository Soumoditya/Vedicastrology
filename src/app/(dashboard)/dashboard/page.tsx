  ...
  return (
    <div>
      ...
      <section className="surface-card mt-12 p-6">
        ...
        >
          {/*
            The follow-up questions, revealed by the same tick that gave consent.

            These used to sit behind a second fold that had to be opened by hand,
            so agreeing to the research appeared to do nothing at all. They are
            still entirely optional — every field can be left blank or cleared
            later — but somebody who has just said yes should be shown what saying
            yes involves rather than sent looking for it.
          */}
          ...
          <p className="mt-2 max-w-2xl text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
            Chart positions alone can only show what is common. To test whether a
            classical rule actually holds, the research needs something to test it
            against. Every field below is optional, and you can change or clear any
            of them at any time.
          </p>
          <ResearchProfileForm
            values={lifeEvents}
